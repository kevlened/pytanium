...
#        self.browser.file("file").file = "C:\SahiPro\userdata\scripts\demo\uploadme.txt"
...
#        self.browser.file("file[]").file = "C:\SahiPro\userdata\scripts\demo\uploadme.txt"
#        self.browser.file("file[][1]").file = "C:\SahiPro\userdata\scripts\demo\uploadme2.txt"
...
#        assert(self.browser.div("using visibility").is_displayed())
#        
#        # TODO: Add by_id and other common selenium selectors
##        assert(not self.browser.byId("nestedBlockInNone").is_displayed())
##        assert(not self.browser.byId("absoluteNestedBlockInNone").is_displayed())
#
#    def test_1(self):
